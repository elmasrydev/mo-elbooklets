...
def get_markdown_files(workspace_dir: Path) -> list[Path]:
    """Find this project's own markdown docs, skipping deps, generated native
    folders (ios/android, regenerated by prebuild), and other agents' dirs."""
    skip = {'.git', 'node_modules', '.expo', 'ios', 'android', '.agent', '.agents'}
    md_files = []
