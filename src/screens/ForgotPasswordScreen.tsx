              ...
              <View style={currentStyles.inputGroup}>
                ...
                <View 
                    style={[
                        ...
                        touchedEmail && !EMAIL_REGEX.test(email) && { borderColor: theme.colors.error || '#FF6B6B' }
                    ]}
                >
                  <Ionicons name="mail-outline" size={20} color={theme.colors.textTertiary} style={currentStyles.inputIcon} />
                  <TextInput
