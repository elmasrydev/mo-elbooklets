            ...
            <View style={currentStyles.inputGroup}>
              ...
              >
                <Ionicons
                  ...
                  size={20}
                  color={touchedConfirm && !isConfirmValid ? '#FF6B6B' : theme.colors.textTertiary}
                  style={currentStyles.inputIcon}
                />
                <TextInput
...
const styles = (config: any) => {
  const { theme, spacing, borderRadius, insets, typography, fontWeight } = config;
